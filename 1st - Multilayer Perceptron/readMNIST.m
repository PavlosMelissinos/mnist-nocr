function [train_images, train_labels, test_images, test_labels] = readMNIST()
% readMNIST Read in MNIST digit set in Le Cun's format
...
% testLabels(i)
%
% Use showMNIST(trainImages, trainLabels) to visualize data.
%
